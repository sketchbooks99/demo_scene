onload = function() {
    ...
    var pos_vbo = create_vbo(torus_data[0]);
    var col_vbo = create_vbo(torus_data[1]);

    set_attribute([pos_vbo, col_vbo], attLocation, attStride);

    var ibo = create_ibo(torus_data[2]);
    ...
    (function(){
        ...
        gl.drawElements(gl.TRIANGLES, torus_data[2].length, gl.UNSIGNED_SHORT, 0);
